import { CreateTaskRequest, CreateTaskResponse, QueryTaskResponse, MotionControlInput, NanoBananaInput, ImageEditInput, ZImageInput, FlexImageInput, Flux2ProTextInput, Flux2ProImageInput, Flux2FlexTextInput, Flux2FlexImageInput } from '../types';
...
export const createTask = async (apiKey: string, model: string, input: MotionControlInput | NanoBananaInput | ImageEditInput | ZImageInput | FlexImageInput | Flux2ProTextInput | Flux2ProImageInput | Flux2FlexTextInput | Flux2FlexImageInput): Promise<CreateTaskResponse> => {
