\# Qwen Image To Image API Documentation

\> Generate content using the Image To Image model

\#\# Overview

This document describes how to use the Image To Image model for content generation. The process consists of two steps:  
...
|-----------|------|----------|-------------|  
| model | string | Yes | Model name, format: \`qwen/image-to-image\` |  
...
|----------|-------|-------------|  
| \*\*Format\*\* | \`qwen/image-to-image\` | The exact model identifier for this API |  
...
\- \*\*Type\*\*: \`string\`  
\- \*\*Required\*\*: Yes  
\- \*\*Description\*\*: Please provide the URL of the uploaded file,The reference image to guide the generation  
\- \*\*Max File Size\*\*: 10MB  
...
{  
  ...
  "input": {  
    ...
    "output\_format": "png",  
    "acceleration": "none",  
    "negative\_prompt": "blurry, ugly",  
    "seed": 42,  
    "num\_inference\_steps": 30,  
    "guidance\_scale": 2.5,  
    "enable\_safety\_checker": true  
  }  
}  
\`\`\`  
\#\#\# Response Example
...
{  
  ...
  "data": {  
    ...
    "model": "qwen/image-to-image",  
    "state": "waiting",  
    "param": "{\\"model\\":\\"qwen/image-to-image\\",\\"input\\":{\\"prompt\\":\\"Enter your prompt here...\\",\\"image\_url\\":\\"\\",\\"strength\\":0.8,\\"output\_format\\":\\"png\\",\\"acceleration\\":\\"none\\",\\"negative\_prompt\\":\\"blurry, ugly\\",\\"seed\\":42,\\"num\_inference\_steps\\":30,\\"guidance\_scale\\":2.5,\\"enable\_safety\_checker\\":true}}",  
    "resultJson": "{\\"resultUrls\\":\[\\"https://v3.fal.media/files/elephant/AuLvZGaYemu6vs36D5zof.png\\"\]}",  
    "failCode": null,  
    "failMsg": null,  
    "costTime": null,  
    "completeTime": null,  
